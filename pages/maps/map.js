...
export default function MainMap() {
  ...
  return (
    <ViewContext.Provider value={viewValue}>
      <div className={styles.gridContainer} data-color={routeClicked ? 'dark' : 'light'}>
        <div
          style={{
            gridArea: '1/1/1/4',
          }}
          ...
          {routeClicked && (
            <>
              <div className={styles.exploreBox}>
                <a href={'/journeys/2'}>
                  Click to explore the experience of migrants on the move from Bamako, Mali to
                  Tripoli, Libya →
                </a>
      ...
      {routeClicked && <MapJourney explorable={routeClicked} style={revealJourney} />}
