                ...
                <Col xs={12} sm={7} className="pt-md-5 pb-5">
                  ...
                  <AboutSection title={'Report'}>
                    {/* <ul>
                      ...
                      <p className='body-5'><Link className='font-sans fw-light' href="#">[Download the report]</Link></p>
                      {/* </li>
                      <li>
                  ...
                  <AboutSection title={'Data Analysis and Methodology'}>
                    <p className='body-5'>
                      This study focuses on irregular migration from the Economic Community of West African States (ECOWAS) countries traveling to Libya. Quantitative data collection for this study was collected by the International Food Policy Research Institute (IFPRI) in Tripoli and Sabha between June and July 2021, with the goals of better understanding the experiences of migrants in Libya. Screening questions were asked to ensure migrants came from ECOWAS countries and a short survey was conducted including modules on their place of origin, their journey to Libya, whether they intended to move on, current employment, and food security status. The resulting survey sample consisted of 347 migrants.*
                    </p>
                    <p className='body-5'>
                      The experiences of West African migrants making their journey to Libya, are visualized through mapped migration routes, analyzed migrant risk data, and interactive illustrations of the journey. The data visualized on this website by the Civic Data Design Lab team are described in the methodology and data source notes below.
                    </p>
                    <p className='note'>
                      *&ensp;Unfortunately, statistics from Niger are not available for this study due to a programming error in the quantitative survey. Secondary research conducted as part of this project suggests that even if migrants from Niger had been included in the sample, the findings would not materially change.
                    </p>
                    <h5>Migration Map and Routes</h5>
                    <p className="body-5">
                      Migration routes visualized on this website focus on migrants originating from ECOWAS countries that travel through the Central Mediterranean route to reach Tripoli and Sabha in Libya.
                    </p>
                    <ul>
                      <li className="mb-2">
                        <h6>Migration routes from West Africa to Libya</h6>
                        <p className="body-5">
                          Migration routes are mapped using origin and destination locations from the Displacement Tracking Matrix data collected by the International Organization for Migration (IOM). The <Link href='https://dtm.iom.int/report-product-series/flow-monitoring-survey' rel='noopener noreferrer' target='_blank'>Flow Monitoring Survey</Link> data collected by IOM contains over 26,000 origin and destination locations of migrants traveling through West Africa between July 2020&ndash;June 2022; roughly 80% of these survey responses could be mapped using the <Link href='https://developers.arcgis.com/rest/geocode/api-reference/overview-world-geocoding-service.htm' rel='noopener noreferrer' target='_blank'>ESRI geocoding service</Link>. These routes show the most efficient paths between the origin in West Africa and the intended destination in Tripoli, Libya computed using the <Link href='https://project-osrm.org/' rel='noopener noreferrer' target='_blank'>Open Source Routing Machine</Link>.
                        </p>
                      </li>
                      <li className="mb-2">
                        <h6>Migrants surveyed by place of origin</h6>
                        <p className='body-5'>
                          Migrants from Economic Community of West African States (ECOWAS) countries were surveyed in Libya (Tripoli and Sabha) in June and July 2021 by the International Food Policy Research Institute; this survey included location data on the origin cities and countries of West African migrants.
                        </p>
                      </li>
                      <li className="mb-2">
                    ...
                    <p className="body-5">
                      Migrants are always at risk while in transit. The migration risk score is a relative scale from 0-100 that indicates variations of extreme risks with higher values, and is a composite of six risk factors, including: migrant reported violence incidents, conflict events, food insecurity, reliance on smugglers, remoteness, and heat exposure. These risk factors are initially weighted evenly, but we invite users to explore the risks further to reflect weights that could appropriately reflect the risks that migrants face while on the move.
                    </p>
                    <p className='body-5'>
                      These six risk factors are not inclusive of all of the risks that migrants face during their journeys. There are limitations on the data available to reflect migrant risks; further details on each risk identified can be found below.
                    </p>
                    <ul>
                      <li className="mb-2">
                        <h6>Reported Violence</h6>
                        <p className="body-5">
                          Migrant reported locations and incidents of death, sexual violence, kidnapping, and physical violence. This 4Mi is based on around 48,000 interviews with refugees and migrants conducted in Africa, collected by the Mixed Migration Centre between 2018-2022. Locations from this dataset were geolocated by place names and aggregated by incident counts within 50 km along the migration route.
                        </p>
                      </li>
                      <li className="mb-2">
                        <h6>Armed Conflict</h6>
                        <p className="body-5">
                          Armed Conflict Location & Event Data of dates, locations, fatalities, and types of all reported political violence and protest events from 2021. Conflict events may not be specifically related to the migrant population, and data was aggregated by the sum of incident counts within a 50km radius of the route.
                        </p>
                      </li>
                      <li className="mb-2">
                        <h6>Food Insecurity</h6>
                        <p className="body-5">
                          Integrated Food Security Phase Classification (IPC) and Cadre Harmonisé data on regional food insecurity in 2021. The IPC Classification System distinguishes acute food insecurity across five severity phases: minimal/none, stressed, crisis, emergency, catastrophe/famine. Food insecurity data that specifically pertains to migrants intransit is not available and difficult to collect. The IPC food insecurity data reflects the local resident populations, and may not specifically relate to the migrants in transit; however, local food insecurity may compound to added risks of migrants as they pass through the area.
                        </p>
                      </li>
                      <li className="mb-2">
                        <h6>Reliance on Smuggler</h6>
                        <p className="body-5">
                          Irregular migrants tend to rely on smugglers more when traveling through areas that restrict freedom of movement, approaching border crossings, and traveling through areas with a perceived need for protection. Risk values were assigned based on the Civic Data Design Lab team’s research and external reporting to address areas along the route where migrants are more likely to rely on smugglers, using the ESRI Africa Boundaries dataset.
                        </p>
                      </li>
                      <li className="mb-2">
                        <h6>Remoteness</h6>
                        <p className="body-5">
                          Remoteness data serves as a proxy for the lack of access to water, food, healthcare, and other resources. This dataset visualizes the driving time access to the nearest city based on the ESRI World Cities dataset and Travel Time tool.
                        </p>
                      </li>
                      <li className="mb-2">
                        <h6>Heat Exposure</h6>
                        <p className="body-5">
                          Many migrants encounter dehydration and exposure to extreme heat. This dataset shows the average of daily maximum temperatures from the MERRA2 satellite data in 2022 in regions that are categorized as barren or sparsely vegetated in the ESRI Africa Land Cover dataset. Although temperatures may fluctuate seasonally and temporally throughout a given day, barren or sparsely vegetated areas, such as in the Sahara Desert, provide less shelter and shading protection from extreme heat.
                        </p>
                      </li>
                    </ul>
                  </AboutSection>
                  <AboutSection title={'Data Sources'}>
                    <ul className="body-5">
                      <li>
                        International Food Policy Research Institute. (June&ndash;July 2021). <span className='fst-italic'>
                          Survey of Irregular Migrants in Libya 2021</span>. {' '}
                          <Link className='font-sans fw-light' href='' target='_blank' rel='noopener noreferrer'>[IFPRI]</Link>
                      </li>
                      <li>
                        International Organization for Migration. (July 2020&ndash;June 2022).
                        <span className='fst-italic'>Displacement Tracking Matrix (DTM), Flow Monitoring Survey</span>. {' '}
                        <Link className='font-sans fw-light' href='https://dtm.iom.int/datasets' target='_blank' rel='noopener noreferrer'>[DTM datasets]</Link>
                      </li>
                      <li>
                        Mixed Migration Centre (2021). <span className='fst-italic'>4Mi</span>. {' '}
                        <Link className='font-sans fw-light' href='https://mixedmigration.org/4mi/' target='_blank' rel='noopener noreferrer'>[4mi resource]</Link>
                      </li>

                      <li className='mt-3'>
                        Earth Resources Observation and Science (EROS) Center. (2019). <span className='fst-italic'>Africa Land Cover</span>. {' '}
                        <Link className='font-sans fw-light' href='https://www.usgs.gov/media/images/africa-land-cover-characteristics-data-base-version-20' target='_blank' rel='noopener noreferrer'>[dataset]</Link>
                      </li>
                      <li>
                      ...
                      <li>
                       Permanent Interstate Committee for Drought Control in the Sahel (CILSS), Integrated Phase Classification (IPC). (2021). <span className='fst-italic'>Cadre Harmonisé (CH) & Integrated Phase Classification (IPC) for West & Central Africa</span>. {' '}
                        <Link className='font-sans fw-light' href='https://www.ipcinfo.org/ch/en/' target='_blank' rel='noopener noreferrer'>[CH & IPC resource]</Link>
                      </li>
                      <li>
                        Raleigh, C., Linke, A., Hegre, H. & Karlsen, J. (2010). <span className='fst-italic'>Introducing ACLED-Armed Conflict Location and Event Data</span>. Journal of Peace Research 47(5), 651- 660. {' '}
                        <Link className='font-sans fw-light' href='https://acleddata.com/' target='_blank' rel='noopener noreferrer'>[ACLED resource]</Link>
                      </li>
                    </ul>
                  </AboutSection>
                  <AboutSection title={'Credits'} className="mb-5 pb-5">
                    ...
                    <p className='body-5 mt-2'>
                      Sarah Williams (Director), Ashley Louie (Project Lead), Enrique Casillas,
