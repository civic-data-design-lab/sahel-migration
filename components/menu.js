                ...
                <Col xs={width > 480 ? 7 : 9} className="pt-5 pb-5">
                  ...
                  <AboutSection title={'Methodology'}>
                    ...
                    <p className="body-5">
                      ...
                      XX,000 responses collected between July 2020 &ndash; June 2022. Origin and
                      destination locations were processed with an Open Street Maps script to
                      produce individual routes for migrants originating in various locations in
                      West Africa, traveling to Tripoli, Libya.
                    </p>
                    <ul>
                      <li>
                        <h6>Route Traffic</h6>
                    ...
                    <p className="body-5">
                      Migrant risk analysis involved analysis of six layers: reported violence,
                      armed conflict, food insecurity, the need for a smuggler, remoteness, and heat
                      exposure.
                    </p>
                    <ul>
                      <li>
                        ...
                        <p className="body-5">
                          ...
                          Centre. Sum of citation count by category within 50km radius of each
                          vertex on the transect in 2021. Risk layer rescales these counts to a
                          0-100 scale for the transect.
                        </p>
                      </li>
                      <li>
                      ...
                      <li>
                        ...
                        <p className="body-5">
                          100: Northeast Niger within 50km of a border; 75: Northeast Niger more
                          than 50km from a border; 50: Libya, Tunisia, Morocco, Algeria within 50km
                          of a border;25: Libya, Tunisia, Morocco, Algeria more than 50km from a
                          border
                        </p>
                      </li>
                      <li>
                        ...
                        <p className="body-5">
                          ...
                          time, 80 if in the 120-150 minute range, 60 in the 90-120 minute range,
                          etc.
                        </p>
                      </li>
                      <li>
                  ...
                  <AboutSection title={'Data Sources'}>
                    <ul>
                      ...
                      <li className="body-5">
                        ...
                        statM_2d_edi_Nx: 2d, Single-Level, Monthly Extremes Detection Indices based
                        on 1991-2020 V2, Greenbelt, MD, USA, Goddard Earth Sciences Data and
                        Information Services Center (GES DISC), Accessed: 10 January 2022,
                        10.5067/O8AX56DO60MI
                      </li>
                      <li className="body-5">
                        Raleigh, C., Linke, A., Hegre, H. & Karlsen, J. (2010). Introducing
                        ACLED-Armed Conflict Location and Event Data. Journal of Peace Research
                        47(5), 651- 660. [ACLED resource].
                      </li>
                    </ul>
                  </AboutSection>
