...
export default function Tooltip(config) {
  ...
  "<h4 class='risk risk-total'>Combined Risk<span id='data-total' class='labelData'>152</span></h4><p class='risk risk-4mi'>Reported Violence<span id='data-4mi' class='labelData'>12</span></p><p class='risk risk-acled'>Armed Conflict<span id='data-acled' class='labelData'>0</span></p><p class='risk risk-food'>Food Insecurity<span id='data-food' class='labelData'>40</span></p><p class='risk risk-smuggler'>Need for a Smuggler<span id='data-smuggler' class='labelData'>0</span></p><p class='risk risk-remoteness'>Remoteness<span id='data-remoteness' class='labelData'>20</span></p><p class='risk risk-heat'>Extreme Heat<span id='data-heat' class='labelData'>80</span></p><h4 class='route-traffic'>Migrants Along the Route</h4><p class='count-migrants'><span id='data-migrants'>2000</span> migrants crossed this route between July 2020&ndash;June 2022</p>"
  : "<h4 class='risk risk-total'>Combined Risk<span id='data-total' class='labelData'>152</span></h4><p class='risk risk-4mi'>Reported Violence<span id='data-4mi' class='labelData'>12</span></p><p class='risk risk-acled'>Armed Conflict<span id='data-acled' class='labelData'>0</span></p><p class='risk risk-food'>Food Insecurity<span id='data-food' class='labelData'>40</span></p><p class='risk risk-smuggler'>Need for a Smuggler<span id='data-smuggler' class='labelData'>0</span></p><p class='risk risk-remoteness'>Remoteness<span id='data-remoteness' class='labelData'>20</span></p><p class='risk risk-heat'>Extreme Heat<span id='data-heat' class='labelData'>80</span></p>";
  ...
  function mousemove(event, risks, risksData) {
    ...
    if (0 <= x0 && x0 < data.length) {
      ...
      if (isOpen) {
        ...
        tooltip.select('.count-migrants').select('#data-migrants').html(d0.migrant_count.toLocaleString('en-US'));
      }
    }
